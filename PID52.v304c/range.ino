...
void rangebuf() {
  ...
  pinMode(19, OUTPUT);   pinMode(21, OUTPUT);   pinMode(22, OUTPUT);
  Serial.printf("\n\n\n      rangeval=%d\n\n", rangeval);
  if (rangeval == 0) digitalWrite(19, HIGH);  digitalWrite(21, LOW);  digitalWrite(22, LOW);
  if (rangeval == 1) digitalWrite(19, LOW);  digitalWrite(21, HIGH);  digitalWrite(22, LOW);
  if (rangeval == 2) digitalWrite(19, LOW);  digitalWrite(21, LOW);  digitalWrite(22, LOW);
  if (rangeval == 3) digitalWrite(19, LOW);  digitalWrite(21, LOW);  digitalWrite(22, HIGH);
  Serial.printf(" $$$$$$$$$$$$$$ rangeval, set range bigts = %d . bits 19,21,22 are set!\n\r", rangeval);
