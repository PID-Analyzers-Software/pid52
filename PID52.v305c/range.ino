...
void rangebuf() {
  ...
  pinMode(19, OUTPUT);   pinMode(26, OUTPUT);   pinMode(35, OUTPUT);
  Serial.printf("\n\n\n      rangeval=%d\n\n", rangeval);
  if (rangeval == 0) digitalWrite(19, HIGH);  digitalWrite(26, LOW);  digitalWrite(35, LOW);
  if (rangeval == 1) digitalWrite(19, LOW);  digitalWrite(26, HIGH);  digitalWrite(35, LOW);
  if (rangeval == 2) digitalWrite(19, LOW);  digitalWrite(26, LOW);  digitalWrite(35, LOW);
  if (rangeval == 3) digitalWrite(19, LOW);  digitalWrite(26, LOW);  digitalWrite(35, HIGH);
  Serial.printf(" $$$$$$$$$$$$$$ rangeval, set range bigts = %d . bits 19,26,35 are set!\n\r", rangeval);
