...
void loop() {
  ...
  Thermostat();
  Serial.println("zw: thermostate finished");
  MenuButton();
    Serial.println("zw: menubutton finished");
  delay(1000);
}
...
void RUNmode() {
  ...
  Serial.println("zw. main zero start.");
  zero();
  Serial.println("zw. main zero finished!");
  Serial.println("zw. main heatcheck start!");
  heatcheck();
  Serial.println("zw. main heatcheck finished!");
  Serial.println("zw. main runit start!");
  runit();
